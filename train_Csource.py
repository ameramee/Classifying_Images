...
from model.challenge_source import Csource
...
def main() -> None:
    ...
    model, start_epoch, stats = restore_checkpoint(model, config("Csource.checkpoint"))
    ...
    while curr_patience < patience:
        ...
        save_checkpoint(model, epoch + 1, config("Csource.checkpoint"), stats)
